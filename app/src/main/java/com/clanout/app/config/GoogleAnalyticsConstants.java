...
public class GoogleAnalyticsConstants
{
    ...
    public static final String SCREEN_EDIT_EVENT_ACTIVITY = "edit";
    public static final String SCREEN_MANAGE_FRIENDS_ACTIVITY = "friends";
    ...
    public static final String SCREEN_UNKNOWN_ZONE = "unknown_zone";
    ...
    public static final String ACTION_ADD_LOCATION_AND_DESCRIPTION = "add_location_and_description";
    ...
    public static final String ACTION_FACEBOOK_PERMISSIONS = "facebook_permissions";
    ...
    public static final String METHOD_CANNOT_CONVERT_TO_ENUM_IN_NOTIFICATION_SERVICE = "cannot_convert_to_enum";
    ...
    public static final String METHOD_Z16 = "z11";
    public static final String METHOD_Z17 = "z12";
    public static final String METHOD_Z18 = "z13";
    public static final String METHOD_Z19 = "z14";
    public static final String METHOD_Z20 = "z15";


    //TODO: 1. APP LAUNCH & Source | 2. Update the tracker UID |
}
